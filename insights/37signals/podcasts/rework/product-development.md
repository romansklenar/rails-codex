...
- **Opinionated software is a point of view, not a style choice**: every product decision — what you refuse to build as much as what you ship — expresses a worldview; the Gantt chart rejection in Basecamp from its first week is the canonical example: "project management is primarily communication" is a stance, not a feature list; customers who internalize that stance become advocates rather than feature-requesters
- **Taste is the gut computer**: product taste is the accumulated sum of experience, exposure, and judgment — it precedes articulation; you feel what is right before you can say why; cultivating taste is a choice, and having the courage to act on it (saying "not good enough," refusing a customer request) is what makes a product cohesive rather than fragmented
- **Point of view is legible in execution, not declaration**: a company's actual values are visible in what they ship and what they refuse — poor customer service was never announced as policy, it was demonstrated; you can dissect any product to reconstruct the values of the people who made it, including the tradeoffs they were willing to make
- **Principles emerge from doing, not planning**: write down your product principles after the product teaches them to you, not before; premature articulation produces aspirations, not truths; Rails doctrine was extracted from Basecamp after it worked, not specified before building began; principles written after repeated decisions that pan out are descriptive and durable
...
- **Spot blocked team members by watching forward momentum, not by running timers** — the signal that someone is stuck is a visible dip in progress on the work itself (a feature not moving, automated check-ins going missing), not the passage of a fixed interval; paying attention to the work and caring about the people doing it is the detection mechanism, not a rigid "no more than one day" rule
- Smart people rarely get stuck on pure competence — repeated stuckness on technical problems alone is a red flag worth investigating; far more common is being stuck due to circumstances outside the work (motivation, personal factors, team dynamics); conflating the two leads to interventions that fix nothing
- **Getting stuck has learning value** — slowing down because you don't understand something forces real comprehension; a quick unsticking that bypasses the confusion produces a person who can proceed but does not understand what they're doing; tolerate productive struggle as long as forward motion eventually resumes
- Delivering understanding cannot be packaged into a paragraph — when someone genuinely lacks competence in an area, a manager handing over a page of explanation rarely resolves it; the understanding has to be built through the person's own struggle; premature rescuing robs the learning
- When competence blockers do occur, AI as a first-pass probe is more efficient than a manager intervention — it tweaks the framing, gets the person's own brain moving again, and doesn't require scheduling; even a hallucinated answer often shifts the mental model enough to restart progress
