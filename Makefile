REPOS = hotwire-native-site stimulus-site turbo-site strada-site hotwire-site
...
init: ## Initialize and clone all submodules
	@$(foreach repo,$(REPOS),git submodule add https://github.com/hotwired/$(repo);)
...
resources: ## Copy handbook/reference/overview docs into resources/
	@rm -rf resources
	@mkdir -p resources resources/hotwire-native resources/stimulus resources/strada resources/turbo
